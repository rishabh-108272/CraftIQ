  ...
  return !loading? (
    <div className='flex-1 h-full flex flex-col gap-4 p-6'>
     ...
     <div className='bg-white h-full w-full rounded-xl overflow-y-scroll'>
      {
        creations.length=== 0 ? (
             <div className="p-6 text-center text-gray-400">No creations found.</div>
        ):(
        creations.map((creation,index)=>(
            ...
            sm:max-w-1/2 lg:max-w-1/3'>
              ...
              justify-end group-hover:justify-between p-3 group-hover:bg-gradient-to-b from-transparent 
              to-block/80 text-white rounded-lg'>
