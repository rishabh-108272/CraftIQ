...
const RemoveObject = () => {
  ...
  return (
    <Protect plan='premium' fallback={<LockedFeature featureName="Object Eraser" />}>
       ...
       <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'> 
          ...
          <input onChange={(event)=>setinput(event.target.files[0])} type="file"  accept='image/*'
          ...
          <textarea onChange={(event)=>setobject(event.target.value)} value={object} rows={4} 
