    ...
    return (
        <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 mt-20'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center mt-4'>
                        ...
                        <button className='cursor-pointer flex items-center justify-center bg-primary h-9 w-9 aspect-square rounded-r'>
                            {/* Arrow icon */}
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="#">CraftIQ</a>. All rights reserved.</p>
